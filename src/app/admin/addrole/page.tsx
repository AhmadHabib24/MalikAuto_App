...
export default function AddRole() {
    ...
    const handleSubmit = async () => {
       const token = localStorage.getItem("access_token");
        ...
        // Check required fields and password match
        if (
            !name ||
            !email ||
            !password ||
    ...
    return (
        <div className="flex flex-col md:flex-row min-h-screen relative">
            ...
            <main className="bg-white flex-1 p-4 md:p-8">
                <h1 className="text-2xl font-bold mb-8">Add New Role</h1>
                ...
                <div className="border border-blue-700 rounded-xl p-6 md:p-10 max-w-5xl mx-auto">
                    <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="flex-shrink-0 text-center">
                            ...
                            />
                            <h2 className="font-semibold text-sm text-blue-800">John Alex</h2>
