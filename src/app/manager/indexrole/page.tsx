...
export default function RoleIndex() {
  ...
  useEffect(() => {
    const fetchRoles = async () => {
      ...
      const country = localStorage.getItem("userCountry"); // 👈 GET FROM LOCAL STORAGE
      ...
      try {
        ...
        // ✅ Filter roles by country if needed
        const filteredRoles = country
          ? response.data.filter((role: Role) => role.country_name === country)
          : response.data;
